...
namespace App.Domain.Core.Contract.AppService
{
    ...
    {
        Task Create(CreateCategoryDto createCategoryDto,CancellationToken cancellationToken,IFormFile image);
        ...
        Task Update(UpdateCategoryDto updateCategoryDto, CancellationToken cancellationToken,IFormFile formFile);
    }
}
